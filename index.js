            ...
            var verifZokAdmin = verifGroupe ? admins.includes(idBot) : false;
             ...
             if(superUser || verifAdmin || !verifZokAdmin  ) { console.log('je fais rien'); return};
                                   ...
                                   // txt += `message supprimé \n @${auteurMessage.split("@")[0]} rétiré du groupe.`;
                                    const gifLink = "https://raw.githubusercontent.com/djalega8000/Toji-MD/main/media/remover.gif";
...
┃ ┃⬡Toji-MD⬡┃
┃    Prefix : [ ${prefixe} ]
┃    *TOJI MD IS ACTIVE NOW*
┃    Total Commandes : ${evt.cm.length}
︎┃    Mode :${md} 
┃  •°• https://whatsapp.com/channel/0029VaoxgWGIN9irWFYTWV2P
┌┤✑  Thanks for Chooising Toji-MD 
│└────────────┈ ⳹        
│©2024-2099 AJSWRLD
└─────────────────┈ ⳹
╚─────────────────···▸▸`;
